...
so a lecture keeps its web address when the semester is reordered. A week's
img/ folder is copied beside the output. The Marp CLI is `marp` (CI installs it
globally); set MARP to run it another way, e.g. MARP="npx --no-install marp".

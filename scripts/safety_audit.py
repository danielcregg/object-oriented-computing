...
TOP_LEVEL_ALLOW_RE = re.compile(
    r"^(\.github/|\.gitignore$|README\.md$|CLAUDE\.md$|AGENTS\.md$|docs/|module/|scripts/|weeks/"
    r"|themes/|\.vscode/|\.devcontainer/|labs/|practice/|mcq/|package\.json$|package-lock\.json$)"
)

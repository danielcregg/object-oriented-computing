...
TOP_LEVEL_ALLOW_RE = re.compile(
    r"^(\.github/|\.gitignore$|\.gitattributes$|README\.md$|CLAUDE\.md$|AGENTS\.md$|docs/|module/|scripts/|lectures-and-labs/"
    r"|themes/|\.vscode/|\.devcontainer/|practice/|mcq/|package\.json$|package-lock\.json$)"
)

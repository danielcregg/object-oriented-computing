...
- Putting it together: a Student class and its objects
...
<!-- diagram source: img/diagram-car-class.mmd -->
![h:300 A Car class: state and behaviour](img/diagram-car-class.svg)

---

## Attributes (also called members) of a class

* The Car class from the diagram is implemented on the next slide.
...
<!-- diagram source: img/diagram-class-vs-objects.mmd -->
![h:230 One class, many objects](img/diagram-class-vs-objects.svg)
...
- The keyword new allocates the object and then calls the class's constructor — the one we just met.
...
## Putting It Together: a Student class
...
## Putting It Together: creating Student objects
...
* In the previous slide student1 and student2 are reference variables.
...
- Using the Student class from earlier — what does this print?

<!-- no-compile -->
```java
Student s1 = new Student("Alice", 20, 3.85);
Student s2 = s1;
Student s3 = new Student("Alice", 20, 3.85);

System.out.println(s1 == s2);
System.out.println(s1 == s3);
```

* `true` — s1 and s2 are two labels on the same object.
* `false` — s3 is a different object, even though its values are identical.
